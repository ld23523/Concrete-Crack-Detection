...
# Experiment settings
# ======================
OUTPUT_DIR = "outputs/efficientnet_full_experiment"
CSV_PATH = os.path.join(OUTPUT_DIR, "efficientnet_b3_full_results.csv")
DETAILS_PATH = os.path.join(OUTPUT_DIR, "efficientnet_b3_detailed_output.txt")
...
def train_one_experiment(
    ...
    write_log(f"Model: EfficientNet-B3")
...
def plot_summary_graphs(results):
    ...
    plt.title("EfficientNet-B3: Validation F1 by Experiment")
    plt.tight_layout()
    ...
    plt.title("EfficientNet-B3: Test Accuracy by Experiment")
    plt.tight_layout()
    ...
    if data_results:
        ...
        plt.ylabel("Test F1")
        plt.title("Effect of Training Data Size on EfficientNet-B3")
        plt.tight_layout()
    ...
    # Graph 4: Learning rate comparison
    lr_results = [r for r in results if "LR" in r["experiment"] and "Data Size" not in r["experiment"]]
    ...
    if lr_results:
        ...
        plt.ylabel("Test F1")
        plt.title("EfficientNet-B3: Effect of Learning Rate on Test F1")
        plt.tight_layout()
        path = os.path.join(figures_dir, "lr_comparison_test_f1.png")
        plt.savefig(path)
        plt.close()
        write_log(f"Saved graph: {path}")
...
def main():
    ...
    write_log("EfficientNet-B3 Full Experiment Started")
    ...
    # =================================================
    # 1. Data size experiment (25%, 50%, 75%, 100%)
    # =================================================
